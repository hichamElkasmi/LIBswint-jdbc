...
public class Opg_DebitApplicationTemp {

	private OpgEnt_Header header;
	private OpgEnt_InitiatorDebitApplication initiator;

	public Opg_DebitApplicationTemp(OpgEnt_Header header, OpgEnt_InitiatorDebitApplication initiator) {
		super();
		this.header = header;
	...
	public String toString() {
		return "Opg_DebitApplicationTemp [header=" + header + ", initiator=" + initiator + "]";
	}
