...
public class OpgReq_ValidateCardPin0209 {
	...
	public OpgReq_ValidateCardPin0209(OpgEnt_Header header, OpgEnt_FilterValidateCardPin initiator) {
			super();
			this.header = header;
